...
window.loadCss('/web/public/podium/podium.css')
window.loadCss('/web/public/podium/podium-animations.css')
...
export default function PodiumFinal(props) {
    ...
    return html`<div ref=${podium} class='podium podiumAnimated'>
        ...
        <audio ref=${fireworks} volume=${props.volume.current} loop src=/web/public/podium/sounds-of-fireworks-exploding.mp3></audio>
        <img class=firework1 src=/web/public/podium/fireworks-blue.svg />
        <img class=firework2 src=/web/public/podium/fireworks-green.svg />
        <img class=firework3 src=/web/public/podium/fireworks-pink.svg />
        ${podiumPlayersHtml}
    </div>`
}
